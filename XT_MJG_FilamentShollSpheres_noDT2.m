...
%        <Item name="Display Sholl Intersections" icon="Matlab">
%          <Command>MatlabXT::XT_MJG_FilamentShollSpheres_noDT2(%i)</Command>
%        </Item>
%       </Submenu>
%      </Menu>
%      <SurpassTab>
...
function XT_MJG_FilamentShollSpheres_noDT2(aImarisApplicationID)
...
%%
qQuestion = {'Sholl Sphere Radius:', 'Number of Spheres:'};
qTitle='Sholl Analysis';
qDefaults = {'10','10'};
...
% result2.SetName(['Sholl Intersections - ',char(vFilaments.GetName)]);
    ...
    for ShollIndex=1:vNumberofSpheres
        ...
        if vShollSpotCount~=0
            ...
            vNewSpots.SetName(sprintf('%s um Sholl Sphere (ID:%s)',...
